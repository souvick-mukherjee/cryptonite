...
const Footer = () => {
    return (
                ...
                <div className="mx-auto max-w-screen-xl px-4 pb-8 pt-16 sm:px-6 lg:px-8">
                        ...
                        <form className="mt-6">
                            <div className="relative max-w-lg">
                                ...
                                <input
                                    ...
                                    id="email"
                                    type="email"
                                    placeholder="hariom@cipherX.com"
                                />
                    ...
                    <div className="mt-16 grid grid-cols-1 gap-8 lg:grid-cols-2 lg:gap-32">
                        <div className="mx-auto max-w-sm lg:max-w-none">
                            <p className="mt-4 text-center text-gray-500 lg:text-left lg:text-lg">
                                ...
                                adipisicing elit. Praesentium natus quod eveniet
                                aut perferendis distinctio iusto repudiandae,
                    ...
                    <div className="mt-16 border-t border-gray-100 pt-8">
                        <p className="text-center text-xs/relaxed text-gray-500">
                            © CipherX 2024. All rights reserved.
                            <br />
                            Created by
                            <a
                                href=""
        ...
        justify-items-start items-start"
          >
            <Link
              className="text-sm font-semibold leading-relaxed text-purple-600
